...
public class TestInterpreter {
    ...
    public TestInterpreter() {
        List<Object[]> data = new ArrayList<>(data());
        options = toEnumSet(data.get(0)); //also can test other
    }
    ...
    Value compileAndRun(String src, String mainFunction, EnumSet<Options> optionsIgnored) {
        ...
        TypeDictionary typeDict = compiler.compileSrc(src, optionsIgnored);
        String compiled = compiler.dumpIR(typeDict);
        System.out.println(compiled);
        Interpreter interpreter = new Interpreter(typeDict);
    ...
    private static EnumSet<Options> toEnumSet(Object[] param) {
        // 假设 param[0] 是单个枚举值，param[1] 可能更多
        if (param.length == 1) {
            return EnumSet.of((Options) param[0]);
        } else {
    ...
    public void testFunction1() {
        String src = "                func foo()->Int {\n" +
                "                    return 42;\n" +
                "                }";
        Value value = compileAndRun(src, "foo");
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.IntegerValue integerValue
            && integerValue.value == 42);
    }

    @Test
    public void testFunction2() {
        String src = "                func bar()->Int {\n" +
                "                    return 42;\n" +
                "                }\n" +
                "                func foo()->Int {\n" +
                "                    return bar();\n" +
        ...
        Value value = compileAndRun(src, "foo");
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.IntegerValue
                && ((Value.IntegerValue) value).value == 42);
    }

    @Test
    public void testFunction3() {
        String src = "                func negate(n: Int)->Int {\n" +
                "                    return -n;\n" +
                "                }\n" +
                "                func foo()->Int {\n" +
                "                    return negate(42);\n" +
    ...
    public void testFunction4() {
        String src = """
                ...
                """;
        Value value = compileAndRun(src, "bar");
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.IntegerValue integerValue
    ...
    public void testFunction8() {
        String src = """
                ...
                """;
        Value value = compileAndRun(src, "foo", Options.OPT);
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.IntegerValue integerValue
    ...
    public void testFunction100() {
        ...
        Value value = compileAndRun(src, "foo", Options.OPT);
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.NullValue);
    }
...
""";
        Value value = compileAndRun(src, "main", Options.OPT);
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.IntegerValue integerValue &&
                integerValue.value == 1);
    }
...
""";
        Value value = compileAndRun(src, "main");
        Assertions.assertNotNull(value);
        Assertions.assertTrue(value instanceof Value.IntegerValue integerValue &&
                integerValue.value == 1);
    }
