...
public class TestInterferenceGraph {
    ...
    private CompiledFunction buildTest1() {
        ...
        Symbol.ParameterSymbol argSymbol = new Symbol.ParameterSymbol("a", typeDictionary.INT);
    ...
    public void test2() {
        ...
        Assertions.assertTrue(edges.contains(new InterferenceGraph.Edge(0, 2)));
        Assertions.assertTrue(edges.contains(new InterferenceGraph.Edge(0, 1)));
        Assertions.assertTrue(edges.contains(new InterferenceGraph.Edge(0, 3)));
    }
    ...
    public void test5() {
        ...
        graph.addEdge(1, 2);
        Assertions.assertTrue(graph.interfere(1, 2));
        Assertions.assertTrue(graph.interfere(2, 1));
        Assertions.assertTrue(graph.neighbors(1).contains(2));
        Assertions.assertTrue(graph.neighbors(2).contains(1));
    }
    ...
    public void test6() {
        ...
        Assertions.assertTrue(graph.interfere(1, 2));
        Assertions.assertTrue(graph.interfere(2, 1));
        Assertions.assertTrue(graph.interfere(1, 3));
        Assertions.assertTrue(graph.interfere(3, 1));
        Assertions.assertFalse(graph.interfere(2, 3));
        Assertions.assertFalse(graph.interfere(3, 2));
        Assertions.assertTrue(graph.neighbors(1).contains(2));
        Assertions.assertTrue(graph.neighbors(1).contains(3));
        Assertions.assertTrue(graph.neighbors(2).contains(1));
        Assertions.assertTrue(graph.neighbors(3).contains(1));
        System.out.println(graph.generateDotOutput());
        graph.rename(2, 3);
        System.out.println(graph.generateDotOutput());
        Assertions.assertFalse(graph.interfere(1, 2));
        Assertions.assertFalse(graph.interfere(2, 1));
        Assertions.assertTrue(graph.interfere(1, 3));
        Assertions.assertTrue(graph.interfere(3, 1));
        Assertions.assertFalse(graph.interfere(2, 3));
        Assertions.assertFalse(graph.interfere(3, 2));
        Assertions.assertFalse(graph.neighbors(1).contains(2));
        Assertions.assertTrue(graph.neighbors(1).contains(3));
        Assertions.assertTrue(graph.neighbors(3).contains(1));
    }
    ...
    public void test7() {
        ...
        Assertions.assertFalse(graph.interfere(1, 2));
        Assertions.assertFalse(graph.interfere(2, 1));
        Assertions.assertFalse(graph.interfere(1, 3));
        Assertions.assertFalse(graph.interfere(3, 1));
        Assertions.assertTrue(graph.interfere(2, 3));
        Assertions.assertTrue(graph.interfere(3, 2));
        Assertions.assertTrue(graph.neighbors(2).contains(3));
        Assertions.assertTrue(graph.neighbors(3).contains(2));
    }
